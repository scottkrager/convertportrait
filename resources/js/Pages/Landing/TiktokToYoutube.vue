        ...
        <main class="max-w-4xl mx-auto px-6">
                ...
                <div class="bg-surface/60 rounded-2xl border border-white/[0.06] p-8 sm:p-10">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="bg-white/[0.02] rounded-xl border border-white/[0.04] p-5 text-center">
                            ...
                            <p class="text-xs text-white/30 font-semibold">TikTok Format</p>
                            <p class="text-[11px] text-white/20 mt-1">Portrait, vertical</p>
                        </div>
                        <div class="bg-white/[0.02] rounded-xl border border-teal/10 p-5 text-center">
                            ...
                            <p class="text-xs text-white/30 font-semibold">YouTube Format</p>
                            <p class="text-[11px] text-white/20 mt-1">Landscape, widescreen</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="pb-16">
                ...
                <div class="grid sm:grid-cols-3 gap-6 stagger">
                    <div class="text-center">
                        ...
                        <h3 class="text-sm font-semibold text-white/70 mb-2">Upload Your TikTok</h3>
                        <p class="text-xs text-white/30 leading-relaxed">Save your TikTok video to your device, then drag and drop it into ConvertPortrait. Supports MP4, MOV, WebM, and AVI.</p>
                    </div>
                    <div class="text-center">
                        ...
                        <h3 class="text-sm font-semibold text-white/70 mb-2">Choose a Background</h3>
                        <p class="text-xs text-white/30 leading-relaxed">Pick from blurred mirror, solid color, gradient wash, or geometric pattern to fill the sides of your landscape video.</p>
                    </div>
                    <div class="text-center">
                        ...
                        <h3 class="text-sm font-semibold text-white/70 mb-2">Download for YouTube</h3>
                        <p class="text-xs text-white/30 leading-relaxed">Get a 1920x1080 landscape video ready to upload to YouTube, embed in presentations, or share anywhere widescreen is expected.</p>
                    </div>
                </div>
            </section>
            ...
            <section class="pb-16 text-center">
                <div class="bg-gradient-to-br from-teal/[0.06] to-emerald/[0.03] rounded-2xl border border-teal/10 p-10">
                    ...
                    <p class="text-sm text-white/40 mb-6 max-w-md mx-auto">Turn your portrait TikTok into a professional landscape video for YouTube in just a few clicks. No signup, no watermark.</p>
